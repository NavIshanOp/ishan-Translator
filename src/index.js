...
function _regeneratorRuntime() {
    ...
    function maybeInvokeDelegate(delegate, context) {
        ...
        return info
            ? info.done
                ? ((context[delegate.resultName] = info.value), (context.next = delegate.nextLoc), "return" !== context.method && ((context.method = "next"), (context.arg = undefined)), (context.delegate = null), ContinueSentinel)
                : info
    ...
    _createClass(GoogleTranslate, null, [
        {
            ...
            value: (function () {
                var _translate = _asyncToGenerator(
                    _regeneratorRuntime().mark(function _callee(source, target, text) {
        ...
        },
        {
            ...
            value: (function () {
                var _requestTranslation = _asyncToGenerator(
                    _regeneratorRuntime().mark(function _callee2(source, target, text) {
